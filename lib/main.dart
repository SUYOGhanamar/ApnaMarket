...
class Product {
  ...
  factory Product.fromJson(Map<String, dynamic> json) {
    return Product(
      ...
      isFoodItem: json['is_food_item'] ?? false,
      hasFSSAI: json['has_fssai'] ?? false,
    );
  }
...
class AppState extends ChangeNotifier {
  ...
  Future<void> loadProducts() async {
    ...
    _products = (response as List)
        .map((json) => Product.fromJson({
              ...json,
              'seller_name': json['profiles']?['name']
            }))
        .toList();
  ...
  Future<void> loadCart() async {
    ...
    _cart = (response as List).map((item) {
...
class _SplashScreenState extends State<SplashScreen> with SingleTickerProviderStateMixin {
  ...
  Future<void> _checkSession() async {
    ...
    if (session != null) {
      ...
      await context.read<AppState>().login(appUser);
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _login() async {
    ...
    try {
      ...
      // 🔥 Update AppState
      await Provider.of<AppState>(context, listen: false).login(user);
        ...
        child: Consumer<AppState>(
          builder: (context, state, _) {
            final featuredProducts =
                state.products.where((p) => p.isFeatured).toList();
